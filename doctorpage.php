...
$query=mysqli_query($connection,"select * from  doctor where doctor_namtional_id = $dr_id") or die(mysql_error());
...
<div id="contents">
       ...
       <form id="form1" name="form1" method="post"  onsubmit="return validate(this);">
               ...
               <td>
                <input name="id" type="text" value="<?php echo $dr_id; ?>" readonly><br />
               ...
               <td>
               <input type="text" name="id" id="lastname"  value="<?php echo $fname." ".$lname; ?>" readonly><br />
               ...
               <td>
			    <input type="text" name="mail"  id="cpass" value="<?php echo $email; ?>" readonly>
               <br />
               ...
               <td>
			    <input type="text" name="mail"  id="cpass" value="<?php echo $category; ?>" readonly>
               <br />
               <font color="red"> <span id="cpasserror"></span></font><br />   
               </td>
               </tr>
